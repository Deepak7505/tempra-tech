    ...
    <div className="px-2">
      <div className="flex sm:flex-row flex-col w-full bg-white mt-2">
        <div className="flex-1 text-center">
          <h1 className="text-5xl font-semibold text-gray-700 sm:mr-16">
            {subCategories[categoryId][0]?.parentCategory}
          </h1>
        </div>
      </div>
      ...
      <div className="pb-4">
        {subCategories[categoryId]?.map((sub, index) => (
          <div className="mt-8" key={index}>
            <h2
              id={sub?.id}
              className="p-1 text-center font-semibold text-xl text-gray-700 mb-3"
            >
              {sub?.name}
            </h2>
            ...
            <div className="relative">
              <div
                ref={carouselRef}
                className={`overflow-x-auto flex space-x-4 pb-4 scroll-smooth carousel-scrollbar ${
                  sub.ProductList.length <= 2 ? "justify-center" : ""
                }`}
